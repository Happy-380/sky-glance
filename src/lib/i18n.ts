...
const D: Dict = {
  ...
  unitSettings: { zh: "单位", en: "Units" },
  otherUnits: { zh: "其他单位", en: "Other Units" },
  restoreDefaults: { zh: "恢复默认值", en: "Restore Defaults" },
  restoreDefaultsDesc: { zh: "将所有天气单位设为你所在地区的默认值。", en: "Set all weather units to your region's defaults." },
  useSystemSettings: { zh: "使用系统设置", en: "Use System Settings" },
  windLevel: { zh: "级（蒲福风级）", en: "Level (Beaufort)" },
  mmAndCm: { zh: "毫米和厘米", en: "Millimeters and centimeters" },
  miles: { zh: "英里", en: "Miles" },
  inches: { zh: "英寸", en: "Inches" },
  mph: { zh: "英里/小时", en: "Miles per hour" },
  kmh: { zh: "公里/时", en: "Kilometers per hour" },
  ms: { zh: "米/秒", en: "Meters per second" },
  kn: { zh: "节", en: "Knots" },
  mbar: { zh: "毫巴", en: "Millibar" },
  inHg: { zh: "英寸汞柱", en: "Inches of mercury" },
  mmHg: { zh: "毫米汞柱", en: "Millimeters of mercury" },
  hpa: { zh: "百帕", en: "Hectopascal" },
  kpa: { zh: "千帕", en: "Kilopascal" },
};
